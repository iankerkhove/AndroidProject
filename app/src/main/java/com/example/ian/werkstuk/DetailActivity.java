            ...
            if (i.getStringExtra("sort").equals("movie")) {
                ...
                fab.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Snackbar.make(view, "Movie added successfully", Snackbar.LENGTH_LONG)
                ...
                fab.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        t.setGenre(genre.getText().toString());
                        t.setNumberOfSeasons(spolanguage.getText().toString());
                        t.setOriLanguage(orilanguage.getText().toString());
                        t.setOverview(overview.getText().toString());
                        t.setProdCompany(productionCountry.getText().toString());
                        t.setReleasedate(release.getText().toString());
                        t.setStatus(statu.getText().toString());
                        t.setVoteAverage(votesAverage.getText().toString());
                        database.TvDAO().insert(t);
                        Snackbar.make(view, "Tv show added successfully", Snackbar.LENGTH_LONG)
                                .setAction("Action", null).show();
                    }
                });
            ...
            if (response == null) {
                ...
                try {
                    ...
                    if (sort.equals("tv")) {
                        ...
                        productionCountryLabel.setText("Production companys: ");
